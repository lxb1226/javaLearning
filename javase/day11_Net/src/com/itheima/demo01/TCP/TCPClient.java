...
/*
    ...
    表示客户端的类：
        java.net.Socket:此类实现了客户端套接字。套接字是两台机器间通信的端点
        套接字：包含了IP地址和端口号的网络位置
    ...
    实现步骤：
        ...
        2.使用Socket对象中的getOutputStream获取网络字节输出流OutputStream对象
    ...
    注意：
        ...
        2.当我们创建客户端对象Socket的时候，就会去请求服务器和服务器经过3此握手建立连接桐庐
